...
tail -f ${WORKING_DIRECTORY}/${WSO2_SERVER}-${WSO2_SERVER_VERSION}/wso2/manager/logs/carbon.log | while read LOG_LINE
do
  # echo each log line
  echo "${LOG_LINE}"
...
echo "Management console URL: https://${NODE_IP}:9190/carbon"
